...
public class AttendenceSubmitter {
	...
	public AttendenceSubmitter(DataSource dataSource,Map<String, String> allRequestParams, Map<String, String> attribute) {
	...
	public boolean addToAttendence()
	{
		try {

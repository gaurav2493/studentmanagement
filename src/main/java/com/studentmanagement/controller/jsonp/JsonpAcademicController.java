...
public class JsonpAcademicController {
	...
	public String getExamList(ModelMap model )
	{
	...
	public String getMarks(@RequestParam(value="exam_id") int examId,@RequestParam(value="session") int session,ModelMap model,HttpServletRequest request)
	{
		ExamReports examReports=new ExamReports(dataSource);
